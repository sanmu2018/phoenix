...
class InlineCodeEvaluatorInput:
    ...
    description: Optional[str] = None
    # Stable session identifier generated by the frontend at form-mount time.
    # Persisting it across rename mid-iteration keeps the sandbox session
    # reused even when ``name`` changes. Optional so stored-evaluator preview
    # and dataset eval paths (which key on DB-stable names) do not break.
