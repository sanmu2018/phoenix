...
class SystemSettings(DaemonTask):
    ...
    def __init__(
        ...
        *,
        ...
        self._cache: dict[SystemSettingKey, BaseModel] = {}
    ...
    def agent_trace_recording(self) -> AgentTraceRecordingSetting:
        cached = self._cache.get("agent.trace_recording")
        if cached:
            return cast(AgentTraceRecordingSetting, cached)
        return AgentTraceRecordingSetting()
    ...
    async def update_agent_trace_recording(
        ...
        *,
        ...
        await self._set("agent.trace_recording", value, user_id=user_id)
    ...
    async def _set(
        ...
        *,
        ...
        stmt = insert_on_conflict(
            {"key": key, "value": payload, "updated_by_user_id": user_id},
